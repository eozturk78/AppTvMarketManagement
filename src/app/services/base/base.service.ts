...
export class BaseService {
  ...
  /*public baseUrl = 'https://api.imc-app.de';
 public othUrl = 'https://app.telecard.io';*/
  public othUrl = 'https://praxiskamalmeo-test.oth.io';
  public baseUrl = 'https://test-api.imc-app.de';
